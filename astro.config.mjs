            ...
            items: [
              ...
              },
              {
                ...
                items: [
                  ...
                  { label: 'Connect local engine', slug: 'refgenie/bridge' },
                ],
              },
              {
                label: 'Server',
            ...
            items: [
              ...
              },
              {
                ...
                items: [
                  ...
                  { label: 'RefgetStore to SSHash', slug: 'refget/using-services/refgetstore-to-sshash' },
                ],
              },
              {
              ...
              },
              {
                ...
                items: [
                  ...
                  { label: 'RefgetStore integration', slug: 'refget/hosting-services/refgetstore-integration' },
                ],
              },
              {
                label: 'Reference',
