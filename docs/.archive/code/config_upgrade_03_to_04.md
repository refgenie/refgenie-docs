...
<title>config_upgrade_03_to_04</title><script src="https://cdnjs.cloudflare.com/ajax/libs/require.js/2.1.10/require.min.js"></script>
<style type="text/css">
    pre { line-height: 125%; }
...
<h1 id="Configuration-file-upgrade-demonstration">Configuration file upgrade demonstration<a class="anchor-link" href="#Configuration-file-upgrade-demonstration">¶</a></h1><p>In the following tutorial we will present the process of upgrading the refgenie configuration file and asset files from version <strong>0.3</strong> to version <strong>0.4</strong>.</p>
<p>First, let's install the refgenie and refgenconf Python packages that support version 0.3 of refgenie configuration file</p>
</div>
</div>
</div>
</div>
...
<h2 id="Working-environment-setup">Working environment setup<a class="anchor-link" href="#Working-environment-setup">¶</a></h2><p>Let's install the legacy refgenconf and refgenie Python packages</p>
</div>
</div>
</div>
...
<div class="highlight hl-bash"><pre><span></span>pip<span class="w"> </span>install<span class="w"> </span><span class="nv">refgenconf</span><span class="o">==</span><span class="m">0</span>.9.3
pip<span class="w"> </span>install<span class="w"> </span><span class="nv">refgenie</span><span class="o">==</span><span class="m">0</span>.9.3
</pre></div>
</div>
</div>
</div>
...
<pre>Collecting refgenconf==0.9.3
...
<span class="ansi-yellow-fg">WARNING: You are using pip version 19.2.3, however version 20.2.3 is available.
...
<p>Now let's set up a directory that we will use for the config file and refgenie assets</p>
</div>
</div>
</div>
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
<div class="cm-editor cm-s-jupyter">
<div class="highlight hl-bash"><pre><span></span><span class="nb">export</span><span class="w"> </span><span class="nv">WORKDIR</span><span class="o">=</span>~/Desktop/testing/refgenie/upgrade_test
rm<span class="w"> </span>-r<span class="w"> </span><span class="nv">$WORKDIR</span><span class="w"> </span><span class="c1"># remove first just to make sure the directory does not exist</span>
...
<p>Let's set <code>$REFGENIE</code> environment variable to point refgenie to the configuration file location and initialize it</p>
</div>
</div>
</div>
</div><div class="jp-Cell jp-CodeCell jp-Notebook-cell">
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
<div class="cm-editor cm-s-jupyter">
<div class="highlight hl-bash"><pre><span></span><span class="nb">export</span><span class="w"> </span><span class="nv">REFGENIE</span><span class="o">=</span><span class="nv">$WORKDIR</span>/g.yml
refgenie<span class="w"> </span>init<span class="w"> </span>-c<span class="w"> </span><span class="nv">$REFGENIE</span><span class="w"> </span>-s<span class="w"> </span>http://rg.databio.org:82/
</pre></div>
</div>
</div>
</div>
...
<div class="jp-OutputPrompt jp-OutputArea-prompt"></div>
<div class="jp-RenderedText jp-OutputArea-output" data-mime-type="text/plain" tabindex="0">
<pre>Initialized genome configuration file: /Users/mstolarczyk/Desktop/testing/refgenie/upgrade_test/g.yml
</pre>
</div>
</div>
</div>
...
<p>Note that we subscribe to a test instance of refgenieserver, that supports both the old and new refgenie clients. This is because it exposes different API versions, that these clients use: <code>v2</code> (refgenie v0.9.3) and <code>v3</code> (refgenie v0.10.0-dev)</p>
<h2 id="Pull/build-test-assets">Pull/build test assets<a class="anchor-link" href="#Pull/build-test-assets">¶</a></h2><p>Next, let's retrieve couple of assets. As mentioned above, <code>v2</code> API is used to retrieve the asset.</p>
</div>
</div>
</div>
</div><div class="jp-Cell jp-CodeCell jp-Notebook-cell">
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
<div class="cm-editor cm-s-jupyter">
<div class="highlight hl-bash"><pre><span></span>refgenie<span class="w"> </span>pull<span class="w"> </span>rCRSd/fasta<span class="w"> </span>human_repeats/fasta<span class="w"> </span>rCRSd/bowtie2_index<span class="w"> </span>human_repeats/bwa_index
</pre></div>
</div>
</div>
</div>
...
<div class="jp-OutputPrompt jp-OutputArea-prompt"></div>
<div class="jp-RenderedText jp-OutputArea-output" data-mime-type="text/plain" tabindex="0">
<pre>Downloading URL: http://rg.databio.org:82/v2/asset/rCRSd/fasta/archive
...
<p>Now, let's download a small FASTA file and build a fasta asset for an arbitrary genome, which is not available at <code>http://rg.databio.org:82/</code></p>
</div>
</div>
</div>
</div><div class="jp-Cell jp-CodeCell jp-Notebook-cell">
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
<div class="cm-editor cm-s-jupyter">
<div class="highlight hl-bash"><pre><span></span>wget<span class="w"> </span>-O<span class="w"> </span>human_alu.fa.gz<span class="w"> </span>http://big.databio.org/refgenie_raw/files.human_alu.fasta.fasta
</pre></div>
</div>
</div>
</div>
...
<div class="jp-OutputPrompt jp-OutputArea-prompt"></div>
<div class="jp-RenderedText jp-OutputArea-output" data-mime-type="text/plain" tabindex="0">
<pre>--2020-10-12 17:39:25--  http://big.databio.org/refgenie_raw/files.human_alu.fasta.fasta
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
<div class="cm-editor cm-s-jupyter">
<div class="highlight hl-bash"><pre><span></span>refgenie<span class="w"> </span>build<span class="w"> </span>human_alu/fasta<span class="w"> </span>--files<span class="w"> </span><span class="nv">fasta</span><span class="o">=</span>human_alu.fa.gz
</pre></div>
</div>
</div>
</div>
...
<div class="jp-OutputPrompt jp-OutputArea-prompt"></div>
<div class="jp-RenderedText jp-OutputArea-output" data-mime-type="text/plain" tabindex="0">
<pre>Using 'default' as the default tag for 'human_alu/fasta'
...
<p>Let's inspect the asset inventory</p>
</div>
</div>
</div>
</div><div class="jp-Cell jp-CodeCell jp-Notebook-cell">
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
<div class="cm-editor cm-s-jupyter">
<div class="highlight hl-bash"><pre><span></span>refgenie<span class="w"> </span>list
</pre></div>
</div>
</div>
</div>
...
<div class="jp-OutputPrompt jp-OutputArea-prompt"></div>
<div class="jp-RenderedText jp-OutputArea-output" data-mime-type="text/plain" tabindex="0">
<pre>Server subscriptions: http://rg.databio.org:82
...
<p>As you can see, assets for all three genomes are available.</p>
</div>
</div>
</div>
</div>
...
<h2 id="Upgrade-refgenie-software">Upgrade refgenie software<a class="anchor-link" href="#Upgrade-refgenie-software">¶</a></h2><p>Now, let's upgrade to refgenie==0.10.0-dev, which introduces the concept of sequence-derived genome identifiers to uniqly identify genomes.</p>
</div>
</div>
</div>
</div><div class="jp-Cell jp-CodeCell jp-Notebook-cell">
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
<div class="cm-editor cm-s-jupyter">
<div class="highlight hl-bash"><pre><span></span>pip<span class="w"> </span>install<span class="w"> </span>git+https://github.com/refgenie/refgenconf.git@dev_config_upgrade
pip<span class="w"> </span>install<span class="w"> </span>git+https://github.com/refgenie/refgenie.git@dev_config_upgrade
</pre></div>
</div>
</div>
</div>
...
<div class="jp-OutputPrompt jp-OutputArea-prompt"></div>
<div class="jp-RenderedText jp-OutputArea-output" data-mime-type="text/plain" tabindex="0">
<pre>Collecting git+https://github.com/refgenie/refgenconf.git@dev_config_upgrade
...
Building wheels for collected packages: refgenconf
  Building wheel for refgenconf (setup.py) ... done
  Created wheel for refgenconf: filename=refgenconf-0.10.0.dev0-cp36-none-any.whl size=64959 sha256=37191046ce6136b2bd777b1aa274a2d6a5ffb508af7e4969ac0ae97c1682b1f5
...
<div class="jp-OutputPrompt jp-OutputArea-prompt"></div>
<div class="jp-RenderedText jp-OutputArea-output" data-mime-type="text/plain" tabindex="0">
<pre>Requirement already satisfied: python-dateutil&gt;=2.6.1 in /Users/mstolarczyk/Library/Python/3.6/lib/python/site-packages (from pandas-&gt;piper&gt;=0.12.1-&gt;refgenie==0.10.0.dev0) (2.8.0)
...
Building wheels for collected packages: refgenie
  Building wheel for refgenie (setup.py) ... done
  Created wheel for refgenie: filename=refgenie-0.10.0.dev0-cp36-none-any.whl size=29266 sha256=d78485a0207036ddd91c36eb66b1973bdb3588aaff925d165d5e5aed483f968c
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
<div class="cm-editor cm-s-jupyter">
<div class="highlight hl-bash"><pre><span></span>refgenie<span class="w"> </span>--version
</pre></div>
</div>
</div>
</div>
...
<p>Execution of refgenie commands fails since the config is incompatible:</p>
</div>
</div>
</div>
</div><div class="jp-Cell jp-CodeCell jp-Notebook-cell">
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
<div class="cm-editor cm-s-jupyter">
<div class="highlight hl-bash"><pre><span></span>refgenie<span class="w"> </span>list<span class="w"> </span>
</pre></div>
</div>
</div>
</div>
...
<h2 id="Upgrade-refgenie-configuration-file">Upgrade refgenie configuration file<a class="anchor-link" href="#Upgrade-refgenie-configuration-file">¶</a></h2>
</div>
</div>
</div>
</div>
...
<p>Let's upgrade the config to v0.4, just as the error message suggests. We will use <code>--force</code> option to run the command in batch mode.</p>
</div>
</div>
</div>
</div><div class="jp-Cell jp-CodeCell jp-Notebook-cell">
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
<div class="cm-editor cm-s-jupyter">
<div class="highlight hl-bash"><pre><span></span>refgenie<span class="w"> </span>upgrade<span class="w"> </span>--force<span class="w"> </span>--target-version<span class="w"> </span><span class="m">0</span>.4
</pre></div>
</div>
</div>
</div>
...
<div class="jp-OutputPrompt jp-OutputArea-prompt"></div>
<div class="jp-RenderedText jp-OutputArea-output" data-mime-type="text/plain" tabindex="0">
<pre>Upgrading v0.3 config file format to v0.4
...
<p>The upgrade succeded for all the assets that were previously managed by refgenie, regardless of the fact if the sequence-derived genome identifiers were avialable on the server. For ones that were not (<code>human_alu</code> genome) refgenie calculated the digest from the locally available FASTA file using the same algorithm that has been used to generate digests for the genomes on the server.</p>
</div>
</div>
</div>
</div><div class="jp-Cell jp-CodeCell jp-Notebook-cell">
...
<div class="jp-CodeMirrorEditor jp-Editor jp-InputArea-editor" data-type="inline">
<div class="cm-editor cm-s-jupyter">
<div class="highlight hl-bash"><pre><span></span><span class="w"> </span>
</pre></div>
</div>
</div>
</div>
