...
<div class="page-hero">
<img src="/legacy/img/refgenie_logo.svg" alt="Refgenie" class="page-hero-logo" />
...
**In a hurry?** Check out the [demo videos](/legacy/demo_videos/) that present the most relevant refgenie features in 3 minutes!
...
And that's it! If you wish to use refgenie in *remote mode*  See [further reading on remote mode in refgenie](/legacy/remote/).
...
See [further reading on downloading assets](/legacy/pull/).
...
See [further reading on building assets](/legacy/build/).
...
This will return the path to the particular asset of interest, regardless of your computing environment. This gives you an ultra-portable asset manager! See [further reading on retrieving asset paths](/legacy/seek/).
...
See [further reading on using refgenie in remote mode](/legacy/remote/).

---
If you want to read more about the motivation behind refgenie and the software engineering that makes refgenie work, proceed next to the [overview](/legacy/overview/).
