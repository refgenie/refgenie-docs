...
**Version `0.10.0` requires an upgrade to the configuration file and asset structure. Please refer to the [upgrade tutorial](/legacy/notebooks/config_upgrade_03_to_04/) for instructions on how to migrate your config upon upgrade to `0.10.0`.**
