...
For many of the following derived assets, you will need the corresponding software to build the asset.  You can either [install software on a case-by-case basis natively](/legacy/build/#install-build-software-natively), or you can [build the assets using `docker`](/legacy/build/#build-assets-with-docker).

### bowtie2_index

<i class="fas fa-file-import"></i> required files: *none*
<i class="fas fa-sliders-h"></i> required parameters: *none*
<i class="fas fa-exclamation-triangle"></i> required asset: [`fasta`](/legacy/available_assets/#fasta)
