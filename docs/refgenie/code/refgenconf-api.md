...
```python
def get_asset_table(self, genomes=None, server_url=None, get_json_url=<function RefGenConf.<lambda> at 0x7f27a63fc180>)
```
...
```python
def get_remote_data_str(self, genome=None, order=None, get_url=<function RefGenConf.<lambda> at 0x7f27a63fcfe0>)
```
...
```python
def listr(self, genome=None, get_url=<function RefGenConf.<lambda> at 0x7f27a63fd120>, as_digests=False)
```
...
```python
def pull(self, genome, asset, tag, unpack=True, force=None, force_large=None, size_cutoff=10, get_json_url=<function RefGenConf.<lambda> at 0x7f27a63fd440>, build_signal_handler=<function _handle_sigint at 0x7f27a67f7060>)
```
...
```python
def seek(self, genome_name, asset_name, tag_name=None, seek_key=None, strict_exists=None, enclosing_dir=False, all_aliases=False, check_exist=<function RefGenConf.<lambda> at 0x7f27a63fc860>)
```
...
```python
def seek_src(self, genome_name, asset_name, tag_name=None, seek_key=None, strict_exists=None, enclosing_dir=False, check_exist=<function RefGenConf.<lambda> at 0x7f27a63fcae0>)
```
...
```python
def seekr(self, genome_name, asset_name, tag_name=None, seek_key=None, remote_class='http', get_url=<function RefGenConf.<lambda> at 0x7f27a63fc9a0>)
```
...
```python
def set_genome_alias(self, genome, digest=None, servers=None, overwrite=False, reset_digest=False, create_genome=False, no_write=False, get_json_url=<function RefGenConf.<lambda> at 0x7f27a63fd760>)
```
...
*Version Information: `refgenconf` v0.12.2, generated by `lucidoc` v0.4.4*